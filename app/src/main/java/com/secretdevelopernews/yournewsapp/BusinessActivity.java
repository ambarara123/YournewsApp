...
public class BusinessActivity extends BaseActivity {
    ...
    String linkUrl = "https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=646fffb9629a40e5a5d099caedd4a572";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loader = (ProgressBar) findViewById(R.id.loaderBusiness);

        expandableListView = (ExpandableListView) findViewById(R.id.listViewBusiness) ;
        expandableListView.setEmptyView(loader);
        ExpandableRecyclerAdapter expandableRecyclerAdapter = new ExpandableRecyclerAdapter(this,BusinessActivity.this,
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int position, int i1, long l) {
                Intent intent = new Intent(BusinessActivity.this, DetailsActivity.class);
    ...
    public class DownloadNews extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String xml) {
            ...
            if (xml.length() > 10) { // Just checking if not empty
                ...
                ExpandableRecyclerAdapter adapter = new ExpandableRecyclerAdapter(BusinessActivity.this,BusinessActivity.this, dataList,listDataChild);
