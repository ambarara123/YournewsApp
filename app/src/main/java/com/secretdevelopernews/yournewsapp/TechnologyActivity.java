...
public class TechnologyActivity extends BaseActivity {
    ...
    String linkUrl = "https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=646fffb9629a40e5a5d099caedd4a572";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loader = (ProgressBar) findViewById(R.id.loaderTech);

        expandableListView = (ExpandableListView) findViewById(R.id.listViewTech) ;
        expandableListView.setEmptyView(loader);
        ExpandableRecyclerAdapter expandableRecyclerAdapter = new ExpandableRecyclerAdapter(this,TechnologyActivity.this,
                dataList,listDataChild);
        expandableListView.setAdapter(expandableRecyclerAdapter);
        expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            @Override
            public boolean onGroupClick(ExpandableListView expandableListView, View view, int position, long l) {
                Intent i = new Intent(TechnologyActivity.this, DetailsActivity.class);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int position, int i1, long l) {
                Intent intent = new Intent(TechnologyActivity.this, DetailsActivity.class);
            ...
            if (xml.length() > 10) { // Just checking if not empty
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        Log.d("sport string", jsonObject.optString(KEY_TITLE).toString());
                    }
                } catch (JSONException e) {
                    Toast.makeText(getApplicationContext(), "Unexpected error", Toast.LENGTH_SHORT).show();
                }

                ExpandableRecyclerAdapter adapter = new ExpandableRecyclerAdapter(TechnologyActivity.this,TechnologyActivity.this, dataList,listDataChild);
