...
public class InternationalActivity extends BaseActivity {
    ...
    String linkUrl = "https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=646fffb9629a40e5a5d099caedd4a572";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       SwipeRefreshLayout swipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.refreshlayout);
        ...
        loader = (ProgressBar) findViewById(R.id.loaderInt);

        expandableListView = (ExpandableListView) findViewById(R.id.listViewInt) ;
        expandableListView.setEmptyView(loader);
        ExpandableRecyclerAdapter expandableRecyclerAdapter = new ExpandableRecyclerAdapter(this,InternationalActivity.this,
                dataList,listDataChild);
        expandableListView.setAdapter(expandableRecyclerAdapter);
        expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            @Override
            public boolean onGroupClick(ExpandableListView expandableListView, View view, int position, long l) {
                Intent i = new Intent(InternationalActivity.this, DetailsActivity.class);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int position, int i1, long l) {
                Intent intent = new Intent(InternationalActivity.this, DetailsActivity.class);
    ...
    public class DownloadNews extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String xml) {
            ...
            if (xml.length() > 10) { // Just checking if not empty
                ...
                ExpandableRecyclerAdapter adapter = new ExpandableRecyclerAdapter(InternationalActivity.this,InternationalActivity.this, dataList,listDataChild);
