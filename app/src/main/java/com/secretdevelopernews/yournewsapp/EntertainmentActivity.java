...
public class EntertainmentActivity extends BaseActivity {
    ...
    String linkUrl = "https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=646fffb9629a40e5a5d099caedd4a572";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //listNews = (ListView) findViewById(R.id.listViewEnter);
        loader = (ProgressBar) findViewById(R.id.loaderEnter);
        expandableListView = (ExpandableListView) findViewById(R.id.listViewEnter) ;
        expandableListView.setEmptyView(loader);
        ExpandableRecyclerAdapter expandableRecyclerAdapter = new ExpandableRecyclerAdapter(this,EntertainmentActivity.this,
                dataList,listDataChild);
        expandableListView.setAdapter(expandableRecyclerAdapter);
        expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            @Override
            public boolean onGroupClick(ExpandableListView expandableListView, View view, int position, long l) {
                Intent i = new Intent(EntertainmentActivity.this, DetailsActivity.class);
        ...
        expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view, int position, int i1, long l) {
                Intent intent = new Intent(EntertainmentActivity.this, DetailsActivity.class);
    ...
    public class DownloadNews extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String xml) {
            ...
            if (xml.length() > 10) { // Just checking if not empty
                ...
                ExpandableRecyclerAdapter adapter = new ExpandableRecyclerAdapter(EntertainmentActivity.this,EntertainmentActivity.this, dataList,listDataChild);
